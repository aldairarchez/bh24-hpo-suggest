...
The Human Phenotype Ontology (HPO) has become a vital resource for researchers and clinicians working in the field of rare diseases.HPO facilitates patient phenotyping and improves the accuracy of clinical descriptions, making it widely used in the creation of patient profiles within patient registries. Its hierarchical organization and interoperability with other ontologies have enhanced its utility in computational tools, such as PubCaseFinder and LIRICAL, which aid in differential diagnosis and variant identification. Despite HPO's success, a significant challenge remains in accurately identifying and recommending relevant phenotypes for deep phenotyping. To address this, we developed a tool designed to recommend HPO terms closely related to given inputs. This tool utilizes a co-occurrence matrix of HPO terms, created from seven years of PubCaseFinder queries, covering approximately 80,000 searches primarily from undiagnosed patients suspected of having rare and genetic diseases. On average, each query includes 4.27 HPO terms, ranging from root to leaf terms. In this study, we divided the search queries into training and test datasets, created a co-occurrence matrix using the training dataset, and demonstrated the predictive accuracy of our tool using the test dataset. Additionally, we show that using extensive HPO-based patient profiles from patient registries as training dataset enhances the tool's accuracy, making it a valuable resource for supporting deep phenotyping in various systems. This, in turn, can lead to more precise patient profiling and diagnosis, ultimately contributing to better patient outcomes.
